...
select m.id, m.date, m.code, m.exchange, m.current_exchange, m.sector,m.industry, m.name, m.type, m.isin, m.cusip, m.updated_at, m.adjusted_close, m.previous_adjusted_close,t.volume,m.last_move
from (
